...
(function () {
    ...
    style.textContent = `
        ...
        #dgDlCard {
            ...
            /* Above the tiles (1081, home.css), below the mega/settings sheet (1083) and the drawer
               (1084/1085) — issue #25: the tiles sit behind the card, the menus over it. The old 1070
               was below the tiles, so a tile painted on top of the card. */
