...
должно быть одинаково"; 2026-09-15 — новый порядок и полные подписи): Table of Contents, Favorites & History, Memo, Dictionary.
...
|---|---|---|---|---|---|
| 1 | Table of Contents | Table of Contents | `/toc` | `/assets/img/maniIcon.png` | `siteroot/assets/img/maniIcon.png` (легаси-репо) |
| 2 | Favorites & History | Favorites & History | `/4as` | `/assets/svg/star.svg` | `public/overrides/svg/star.svg` (наш файл) |
| 3 | Memo | Memo | `/memo` | `/assets/svg/memo.svg` | `siteroot/assets/svg/memo.svg` (легаси-репо) |
| 4 | Dictionary | Dictionary | `/dict` | `/assets/svg/book-letter.svg` | `public/overrides/svg/book-letter.svg` (наш файл) |
...
манифест — Table of Contents, Favorites & History, Memo, Dictionary (`res/xml/shortcuts.xml`, иконки из dg-twa).
...
| 3 | Memo (`/memo`) | статический, теперь внутри приложения |
| 4 | Dictionary (`/dict`) | статический, открывается в браузере (серверная страница) |
